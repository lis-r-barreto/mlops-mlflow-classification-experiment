...
def load_model():
    ...
    """
    print('reading model...')
    MLFLOW_TRACKING_URI = 'https://dagshub.com/lis-r-barreto/mlops-mlflow-experiments.mlflow'
    MLFLOW_TRACKING_USERNAME = 'lis-r-barreto'
    MLFLOW_TRACKING_PASSWORD = '4e756087b8703385f28b2787fca9832416cc0c83'
